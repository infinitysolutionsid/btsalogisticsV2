            ...
            <div class="container clearfix">
                <div class="row">
                    ...
                    <div class="col-md-4 px-4 mb-5">
                        ...
                        <a href="mailto:support@btsa.co.id?cc=market@btsa.co.id"
                            title="If you need quotation, price, etc, please send CC to market@btsa.co.id"
                            class="mb-1 d-block"><i class="icon-envelope21 position-relative" style="top: 1px;"></i>
                            support@btsa.co.id</a>
                        <a href="mailto:support@btsa.co.id?cc=market@btsa.co.id"
                            title="If you need quotation, price, etc, please send CC to market@btsa.co.id"
                            class="mb-1 d-block"><i class="icon-envelope1 position-relative" style="top: 1px;"></i>
                            market@btsa.co.id</a>
